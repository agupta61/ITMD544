...
{
$thumbWidth=100;
$pathToThumbs="/var/www/html/uploads/";
/* Attempt to open */
...
$link->real_query("SELECT * FROM USER_INFO where id=$messageBody");
$res = $link->use_result();
...
if (strpos($imgtype,'.jpeg') !== false or strpos($imgtype,'.jpg') !== false) {
    //image compression starts
error_log("raw jpeg url $imgurl");
$cmpimg = LoadJpeg($imgurl);
//store image to upload folder
$value=rand();
$file_name="thmb$value.jpeg";
imagejpeg($cmpimg,"/var/www/html/uploads/$file_name");
}
